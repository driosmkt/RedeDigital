document.addEventListener("DOMContentLoaded", () => {
    ...
    const secretariatsData = [
        ...
        { name: 'Desenvolvimento Rural', cadastros: 26, cliques: 320, membros: 150 }, // Total de cadastros agora é 500
    ...
    // FUNÇÃO DE RENDERIZAÇÃO DO RANKING ATUALIZADA
    function renderRankings() {
        ...
        // **NOVO:** Calcula os valores máximos apenas do pódio
        ...
        // Passa os valores máximos para a função que cria os cards
    ...
    // FUNÇÃO DE CRIAÇÃO DO CARD DO PÓDIO ATUALIZADA
    function createPodiumCard(data, rank, maxValues) {
        ...
        // **NOVO:** Calcula a porcentagem com base nos valores máximos do pódio
        ...
        // **NOVO:** Estrutura sem o botão "Ver Detalhes"
        return `
