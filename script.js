...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- LÓGICA DO BRILHO DO MOUSE (NOVO) ---
    ...
    // --- ATIVA O EFEITO DE INCLINAÇÃO NOS CARDS (NOVO) ---
    // Seleciona todos os cards que devem ter o efeito
    const tiltElements = document.querySelectorAll('.card-tilt');
    VanillaTilt.init(tiltElements, {
        max: 5,       // Inclinação máxima em graus
        speed: 300,   // Velocidade da animação
        glare: true,  // Adiciona um efeito de brilho no card
        "max-glare": 0.2 // Intensidade do brilho
    });
    // --- FIM DA ATIVAÇÃO DO EFEITO ---
});
